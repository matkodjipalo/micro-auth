# Contribute to micro-auth
Did you find a bug or would you like to contribute a feature? You are certainly welcome to do so.
Please always fill an [issue](https://github.com/gyselroth/micro-auth/issues/new) first to discuss the matter.
Do not start development without an open issue otherwise we do not know what you are working on. 

## Bug
If you just want to fill a bug report, please open your [issue](https://github.com/gyselroth/micro-auth/issues/new).
...
### Get the base
```
git clone https://github.com/gyselroth/micro-auth.git
```
...
[![Build Status](https://travis-ci.org/gyselroth/micro-auth.svg)](https://travis-ci.org/gyselroth/micro-auth)

## Code of Conduct
Please note that this project is released with a [Contributor Code of Conduct](https://github.com/gyselroth/micro-auth/CODE_OF_CONDUCT.md). By participating in this project you agree to abide by its terms.

## License
This software is freely available under the terms of [GPL-3.0](https://github.com/gyselroth/micro-auth/LICENSE), please respect this license
